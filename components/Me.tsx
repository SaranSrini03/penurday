...
import { Settings, Share2, ArrowLeft, MoreHorizontal, Heart, MessageCircle, Repeat2, Send } from "lucide-react";
    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white max-w-xl mx-auto border-x border-gray-200 dark:border-gray-800">
      ...
      <nav className="flex border-b border-gray-200 dark:border-gray-800 sticky top-[73px] bg-white dark:bg-black z-20">
        <button
          ...
          className={`flex-1 py-4 text-center font-semibold transition-colors relative ${activeTab === "threads"
        ...
        <button
          ...
          className={`flex-1 py-4 text-center font-semibold transition-colors relative ${activeTab === "replies"
              ? "text-gray-900 dark:text-white"
              : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
            }`}
        >
